...
MODEL_DIR = Path(settings.BASE_DIR) / 'case_studies' / 'customer' / 'ml_models'
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Features (NO days_since_last_rental → prevents leakage)
        ...
        self.stdout.write(f"\n📈 Accuracy: {accuracy:.2%}")
        self.stdout.write(f"🔁 CV Mean: {cv_scores.mean():.2%}")
        self.stdout.write(f"\n🔑 Feature Importance:\n{importances}")
        self.stdout.write(f"\n📋 Report:\n{report}")
